 ...
 */
uc.utils.enableDragDrop = function (daContext, config, initFn) {

    const pluginName = 'UC - Enable Drag and Drop';
    ...
    uc.utils.dragger = uc.utils.dragger || {};
    ...
    if (uc.utils.dragger[regionId]) {
        uc.utils.dragger[regionId].destroy();
    }
    ...
    if (mode == 'swap') {
        ...
        uc.utils.dragger[regionId] = dragger;
    ...
    function updateSequence(updateJson) {
        ...
        apex.event.trigger(daContext.affectedElements, 'uc-enabledraganddrop-sequence-update', updateJson);
        ...
        if (config.action === 'plsql') {
            ...
            result.done(function (data) {
                apex.event.trigger(daContext.affectedElements, 'uc-enabledraganddrop-update-complete', updateJson);
