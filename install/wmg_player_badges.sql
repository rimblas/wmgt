...
-- table index
create index wmg_player_badges_i01 on wmg_player_badges (player_id);
create index wmg_player_badges_i02 on wmg_player_badges (tournament_session_id);
create index wmg_player_badges_i03 on wmg_player_badges (badge_type_code);
