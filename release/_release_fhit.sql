...
-- excluded course from FHIT
update wmg_courses
   set tournament_excluded_flag = 'Y'
 where (course_mode = 'E' or code in ('MYH', 'MWH', 'UTH', 'ILH', 'JCH'))
   and tournament_excluded_flag is null
/

alter table wmg_rounds drop constraint wmg_round_week_ck;


insert into wmg_parameters (category, name_key, value) values ('FHIT', 'FHIT_INVITE_CODE', 'FHITONE2024');
